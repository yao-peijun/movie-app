...
- Filter by "Comedy", movies with genre: Comedy would display. e.g. (Comedy) Duplex and Alice in the Wonderland
  ![Filter by Comedy](src/asset/image/ui-display/filter_1.JPG)

- Filter by "Comedy" and "2006", movies with genre - Comedy or production_year - 2006 would display. e.g. (Comedy) Duplex and Alice in the Wonderland, and (2006) Barnyard
